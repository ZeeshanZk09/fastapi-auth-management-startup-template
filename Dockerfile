...
ENV PATH="$POETRY_HOME/bin:$POETRY_VIRTUALENVS_PATH/bin:/app/app:$PATH"
...
RUN curl -sSL https://install.python-poetry.org | python3 - && \
    ...
    poetry config --list && \
    mkdir -p /app/app ${POETRY_VIRTUALENVS_PATH} /app/tmp/in /app/tmp/out
...
# created during poetry install step
